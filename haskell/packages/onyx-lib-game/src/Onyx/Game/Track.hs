    ...
    in catMaybes
      [ do
        ...
        let name = case fpart of
              ...
              _                         -> F.displayPartName fpart <> " [RS Guitar]"
      ...
      , do
        ...
        let name = case fpart of
              ...
              _                       -> F.displayPartName fpart <> " [RS Bass]"
            ...
            DrumsElite -> case drumTrackTrue fpart pdrums diff of
              ...
              Just trkElite ->
                [ ( case fpart of
                    ...
                    _           -> F.displayPartName fpart <> " [Elite Drums] (" <> letter <> ")"
